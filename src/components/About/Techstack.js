...
import VueIcon from "../../Assets/TechIcons/Vue.js.svg";
...
function Techstack() {
  return (
    <Row style={{ justifyContent: "center", paddingBottom: "50px" }}>
      ...
      <Col xs={4} md={2} className="tech-icons">
        <img src={MongoDB} alt="MongoDB" className="tech-icon-images" />
        <div className="tech-icons-text">MongoDB</div>
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <img src={MSSQL} alt="MSSQL" className="tech-icon-images" />
