      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>            
            ...
            <br />Here I develop software for our in-house ERP: <span className="purple">Flowcontrol.</span>
            <br />I'm also part of the tech company <span className="purple">.Hey</span>
          
            <br />
            <br />
            Outside of coding, I have a few interests that keep my creative side busy:
          </p>
